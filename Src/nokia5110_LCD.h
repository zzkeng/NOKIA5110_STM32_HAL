 ...
 *
 *  2) This library was built to control 5110 for STM32.
 *
 ...
 * --------------------
 * Author: zzkeng
 * Github: https://github.com/zzkeng/NOKIA5110_STM32_HAL
 * --------------------
 */
...
void LCD_setSPI(SPI_HandleTypeDef *_DRIVER_SPI);
/*----- Library Functions -----*/
